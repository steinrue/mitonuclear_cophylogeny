...
rule get_jpt_mt_tree:
  input:
    ...
    expand("{tmp_dir}/JPT/JPT_chr19/JPT_chr19.vcf.gz", tmp_dir=config['tmp_dir']),
    expand("{tmp_dir}/JPT/JPT_MT.hsd", tmp_dir=config['tmp_dir']),
    expand("{trees_dir}/JPT/JPT_chr19.trees", trees_dir=config['trees_dir']),
    expand("{tmp_dir}/JPT/JPT_samples.list", tmp_dir=config['tmp_dir']),
